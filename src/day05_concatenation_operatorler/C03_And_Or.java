...
public class C03_And_Or {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(   ! (not >= 50 && not <=80)   ); //  ! istenmeyen durum    ONEMLI



        // eger istenen durum bir aralik ise && operatoru kullanilir.
        // eger istenen durum bir araligin disinda kalan kalan bolge  íse OR ||  kullanilir  yada araligi & ile yazip basina unlem konur

...
public class C03_VerilenSoyIsmeSahipOgrenciListesiYazdirma {
    public static void main(String[] args) {
        ...
        String istenenSoyIsim = "Can";
        // istenen soyisme sahip ögrencilerin, numara, isim ve bolumlerini yazdirin

        // 1- keySet'i olusturalim

        Set<Integer> keySeti = ogrenciMap.keySet();

        // 2- keySet'indeki herbir key'in value'sine ulasmak icin bir for- each loop kullanalim

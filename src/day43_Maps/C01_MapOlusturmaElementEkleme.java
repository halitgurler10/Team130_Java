...
public class C01_MapOlusturmaElementEkleme {
    ...
    public static void main(String[] args) {
        ...
        /*
               ...
               1. ogrenciMap.get(ogrenciNo) ile String olarak tum value'yu alip kaydederiz
               2. Value , pekcok bilgi barindirdigindan, her bir bilgiye ulasmak icin
               value.split("-") ile value'yu array'e ceviririz
               3. Array'deki tum bilgilerin index'lerine sahip oldugumuzdan
               istenen bilgileri array'dan alip yazdirabilir veya kullanabiliriz
         */

...
public class C02_LastIndexOf {
    ...
    public static void main(String[] args) {
        ...
        // e 'nin son kullaniminin indexini yazdirin

        System.out.println(str.lastIndexOf("e"));  // 17


        // u 'nun  ilk kullanim ve son kullanim indexlerini yazdirin
        ...
        if (str.indexOf("J")== -1){
            ...
            System.out.println("Metinde J sadece 1 tane var");


            // "Bu Java ogrenilecek";
            System.out.println(str.lastIndexOf("e", 15)); // 15
            System.out.println(str.lastIndexOf("e", 14));  //11
            System.out.println(str.lastIndexOf("x")); // -1   olamayan bir index i bu da -1 olarak verir
